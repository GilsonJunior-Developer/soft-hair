...
/**
 * Shared layout for /auth/* pages (recuperar-senha, nova-senha).
 * Mirrors the (auth) route group layout so visuals stay consistent.
 * The /auth/callback route is a route handler (no UI) so this layout
 * doesn't affect it.
 */
